...
\affiliation{%
  ...
  \city{Shanghai}
  \country{China}}
\email{25110980014@m.fudan.edu.cn}
...
\affiliation{%
  ...
  \city{Shanghai}
  \country{China}}
\email{22300160050@m.fudan.edu.cn}
...
matched controls. Across 11 full-split SGDet runs, grounded-object rates expose
bottlenecks hidden by end-to-end scores. Three-seed TDE-Motifs tuning improves
object Top-1 and calibration, but has no stable grounding advantage over
supervised control; the selected checkpoint reduces SGDet mR@50 by
\keynum{6.35} points. Overall, \textsc{GroundedSGG-Bench} provides a
...
{Code, manifests, and reproduction instructions.}
\par\normalsize\smallskip
...
and relation quality rather than a single end-to-end score. The reviewer
artifact provides the experiment contracts, manifests, and
...
anonymous repository} for independent verification, reuse, and direct
inspection of all reported claim boundaries.
